...
// console.log(87/15) //5.8 
// console.log(Math.round(87/15)) // 6
...
// console.log(Math.ceil(19.01247502)) // 20
...
// console.log('15/7 is ' + num + ' with a remainder of ' + remainder ) // 15/7 is 2 with a remainder of 1

/* -------------------------------------------------------------------------- */

// Math.abs() definition: returns the absolute number. Will return positive numbers only 

// console.log(Math.abs(15-6)) // 9
// console.log(6-15) // -9
// console.log(Math.abs(6-15)) // 9

/* -------------------------------------------------------------------------- */

// Math.min() difinition: returns the minimum number 

// console.log(Math.min(7, 20, 4, 1, 25, 7, 3, 3.14, 24, -1, -100, -7)) // -100

/* -------------------------------------------------------------------------- */

// Math.max() definition: returns the maximum number 

// console.log(Math.max(7, 20, 4, 1, 25, 7, 3, 3.14, 24, -1, -100, -7)) //25
